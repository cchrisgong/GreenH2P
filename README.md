...
## System scope
![image](https://github.com/user-attachments/assets/f450978b-12ee-417b-b57e-932f7e30dbe3)
...
- `CF_NM_2023.csv`: Input data file containing renewable energy capacity factors for wind and PV.
...
- Cost breakdown and Levelized Cost of Energy (LCOE).
